...
urlpatterns = [
    ...
    path('password-new/', user_views.new_password, name='password-new'),
    ...
    path('password-reset-confirm', auth_views.PasswordResetConfirmView.as_view(template_name='users/password_reset_confirm.html'), name='password-reset-confirm'),
